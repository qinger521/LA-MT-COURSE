...
class BlockTransformerModel(FairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        encoder = BlockTransformerEncoder(args, src_dict, encoder_embed_tokens)
        decoder = BlockTransformerDecoder(args, tgt_dict, decoder_embed_tokens)
        return BlockTransformerModel(encoder, decoder)



class BlockTransformerEncoder(FairseqEncoder):
    """
...
class BlockTransformerDecoder(FairseqIncrementalDecoder):
    """
...
@register_model_architecture('block_transformer', 'block_transformer')
