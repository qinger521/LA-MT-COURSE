...
@register_model('dense_transformer')
class DenseTransformerModel(FairseqModel):
    ...
    def build_model(cls, args, task):
        ...
        encoder = DenseTransformerEncoder(args, src_dict, encoder_embed_tokens)
        decoder = DenseTransformerDecoder(args, tgt_dict, decoder_embed_tokens)
        return DenseTransformerModel(encoder, decoder)



class DenseTransformerEncoder(FairseqEncoder):
    """
...
class DenseTransformerDecoder(FairseqIncrementalDecoder):
    """
...
@register_model_architecture('dense_transformer', 'dense_transformer')
...
@register_model_architecture('dense_transformer', 'dense_transformer_wmt_en_de')
...
@register_model_architecture('dense_transformer', 'dense_transformer_t2t_wmt_en_de')
