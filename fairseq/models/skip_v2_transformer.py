...
@register_model('skip_v2_transformer')
class SkipV2TransformerModel(FairseqModel):
    """
...
@register_model_architecture('skip_v2_transformer', 'skip_v2_transformer')
...
@register_model_architecture('skip_v2_transformer', 'skip_v2_transformer_wmt_en_de')
def skip_v2_transformer_wmt_en_de(args):
    args.layer_p = 0.2
    args.encoder_layers = 20
    base_architecture(args)


@register_model_architecture('skip_v2_transformer', 'skip_v2_transformer_t2t_wmt_en_de')
def skip_v2_transformer_t2t_wmt_en_de(args):
    args.layer_p = 0.2
...
@register_model_architecture('skip_v2_transformer', 'skip_v2_relative_transformer_wmt_en_de')
def skip_v2_relative_transformer_wmt_en_de(args):
